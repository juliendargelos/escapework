...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { kind: @problem.kind, solution: @problem.solution, workshop_id: @problem.workshop_id } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { kind: @problem.kind, solution: @problem.solution, workshop_id: @problem.workshop_id } }
