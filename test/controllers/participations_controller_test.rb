...
class ParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post participations_url, params: { participation: { team_id: @participation.team_id, user_id: @participation.user_id } }
    end
  ...
  test "should update participation" do
    patch participation_url(@participation), params: { participation: { team_id: @participation.team_id, user_id: @participation.user_id } }
